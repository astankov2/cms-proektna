...
export class CreatePostView extends Component {
	...
	toggleHTMLView() { this.setState({ showHTMLView: !this.state.showHTMLView }); }
		...
		return (
			<div className="CreatePostView">
				...
				<div className="page-content">
					...
					<Form onSubmit={this.onCreatePostClicked.bind(this)}>
						<FormGroup>
						...
						<Button type="submit" primary="true">Create Post</Button>
					</Form>
				</div>
			</div>
		);
